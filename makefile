...
test_objs      := $(addprefix $(obj_dir)/, test_bw.o test_dataset.o test_fwbw.o test_hmm.o test_read.o test_rnd.o test_stats.o test_vmath.o)
test_apps      := $(addprefix $(bin_dir)/, bw.test dataset.test fwbw.test hmm.test read.test rnd.test stats.test vmath.test)
...
$(bin_dir)/bw.test: $(addprefix $(obj_dir)/, test_bw.o bw.o dataset.o fwbw.o hmm.o libma.o read.o rnd.o stats.o vmath.o)
...
$(obj_dir)/hmm.o: hmm.h libma.h rnd.h vmath.h
